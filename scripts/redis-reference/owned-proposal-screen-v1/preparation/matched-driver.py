...
NEW_REVISION = "71c9d996e1dcc0897da14be1886e669f0c3ea773"
...
SERVER_PINS = {
    ...
    "new": dict(revision=NEW_REVISION,
                binary_sha256="b740e3d3c7ca1ad6cac2ed901d2c8a52b128c7c6456f95407f479bb61f414033",
                manifest_sha256="b3cd4c20bd5033bf3651ec9c2bbee008ecdee10a81b724f40a9e513fd91448b3"),
}
...
def main():
    ...
    parser.add_argument("--new-server-source", type=Path, default=Path("/tmp/kv9-owned-proposal-buffers"))
    parser.add_argument("--new-server-build", type=Path, default=Path("/tmp/kv9-owned-proposal-release-first"))
