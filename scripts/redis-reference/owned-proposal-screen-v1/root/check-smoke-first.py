...
sys.path.insert(0,'/tmp/kv9-owned-proposal-screen-preparation/statistics')
from core import phase_accounting
root=Path('/tmp/kv9-owned-proposal-screen-root-preparation')
...
p=Path('/tmp/kv9-owned-proposal-screen-smoke-first/matrix.json');matrix=json.loads(p.read_text())
