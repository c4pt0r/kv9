...
NEW_REVISION = "57ff6851e40ed63c837189d6eb0a11190704725a"
...
def main():
    ...
    parser.add_argument("--new-server-source", type=Path, default=Path("/tmp/kv9-read-group-credit"))
    parser.add_argument("--new-server-build", type=Path, default=Path("/tmp/kv9-read-group-credit-release-first"))
