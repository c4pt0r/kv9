...
NEW_REVISION = "1b70dba62e492cd8e10dd20f643fee74d39abc57"
...
SERVER_PINS = {
    ...
    "new": dict(revision=NEW_REVISION,
                binary_sha256="ab05a16fd520d4c612b01cedea1a514411e607eb0bc645ce28fce24b3299d1ef",
                manifest_sha256="800e74e36f7de539bb38d3cfe097e356ed2ebd1e33d16d7b48435eb6f2bc93f3"),
}
...
def main():
    ...
    parser.add_argument("--new-server-source", type=Path, default=Path("/tmp/kv9-work-signal-coalescing"))
    parser.add_argument("--new-server-build", type=Path, default=Path("/tmp/kv9-work-signal-coalescing-release-first"))
    ...
    plan = dict(version=2, protocol_id="kv9-work-signal-c1-c64-v1",
