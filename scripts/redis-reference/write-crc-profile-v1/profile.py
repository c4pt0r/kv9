#!/usr/bin/env python3
"""Two exact-baseline point PUT/batch64 PUT CPU profiles; no QPS acceptance."""
import argparse
import hashlib
...
DRIVER=Path('/tmp/kv9-v3-workload-comparison-preparation/matched-driver.py')
DRIVER_SHA='e1b839d357658db56b2cf4235e1de7089453e61853ada07015e28d165f1966de'
...
def main():
    ...
    protocol=dict(version=1,protocol_id='kv9-write-apply-cpu-v1',background_container_isolation=False,instrumented=True,throughput_acceptance=False,server_revision=driver.OLD_REVISION,
