...
NEW_REV = 'ca0002c7f8e9ee6f595efcc9f4151085ccce87cb'
REDIS_REV = CLIENT_REV
REDIS_SOURCE = SOURCE
PINS = {
 'old': (OLD_REV, '0d5ffa081482945d213b88aef12222afab44a44ed03bf46cf27bd292db7b1711'),
 'new': (NEW_REV, 'b33b5d302f901aac5cf6a95449b9bb5dd68473747e011220dbed7aed2e591d13'),
...
PROTOCOL_ID = 'kv9-crc-broad-workloads-c1-c64-v1'
CONCURRENCIES = (1, 64)
...
ROLE_PATHS = {
 ...
 'new': ('/tmp/kv9-wal-crc32-table', '/tmp/kv9-wal-crc32-release-first', 'kv9'),
...
SERVER_MANIFESTS = {
 ...
 'new': '8c2ea115afc1ec8b6c82224dc6449d1d2439f5f27b5758e45090589752d186e8',
}
...
try:
    ...
    expected_argv=['/usr/bin/python3','/tmp/kv9-crc-broad-workloads-preparation/matched-driver.py',
                   ...
                   '--new-server-source','/tmp/kv9-wal-crc32-table',
                   '--new-server-build','/tmp/kv9-wal-crc32-release-first',
    ...
    require(invocation['argv']==expected_argv and invocation['wrapper_sha256']==
            ...
            invocation['driver_arguments_sha256']=='ba0968f92c52e648742fd223020e9d0cc01da4091866a1799acb7fe12081128d',
    ...
    require(matrix['helper_hashes'][str(Path('/tmp/kv9-crc-broad-workloads-preparation/matched-driver.py'))]==args.expected_driver_sha256,
