...
def matrix():
    ...
    return dict(version=2, protocol_id='kv9-inbox-drain-c1-c64-v1',
...
class AuditContract(unittest.TestCase):
    ...
    def test_exact_candidate_and_control_pins_are_distinct(self):
        self.assertEqual(audit['PINS']['new'], ('c3131800b665f6f160a11c804f542237e77ab83a',
                         '26a185509cccf6436c5f02a5ab4476efca551166d1d4ef43ea2c200cc5a9e513'))
        self.assertEqual(audit['SERVER_MANIFESTS']['new'],
                         'fae8fd537f53b0a4e9cd09673230a33c97519e4a1e0311f20e1a74c4340e1a20')
