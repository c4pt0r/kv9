...
NEW_REV = 'c3131800b665f6f160a11c804f542237e77ab83a'
...
PINS = {
 ...
 'new': (NEW_REV, '26a185509cccf6436c5f02a5ab4476efca551166d1d4ef43ea2c200cc5a9e513'),
...
PROTOCOL_ID = 'kv9-inbox-drain-c1-c64-v1'
CONCURRENCIES = (1, 64)
...
ROLE_PATHS = {
 ...
 'new': ('/tmp/kv9-raft-inbox-drain-reuse', '/tmp/kv9-inbox-drain-release-first', 'kv9'),
...
SERVER_MANIFESTS = {
 ...
 'new': 'fae8fd537f53b0a4e9cd09673230a33c97519e4a1e0311f20e1a74c4340e1a20',
}
records = {}
...
try:
    ...
    expected_argv=['/usr/bin/python3','/tmp/kv9-inbox-drain-comparison-preparation/matched-driver.py',
    ...
    require(matrix['helper_hashes'][str(Path('/tmp/kv9-inbox-drain-comparison-preparation/matched-driver.py'))]==args.expected_driver_sha256,
