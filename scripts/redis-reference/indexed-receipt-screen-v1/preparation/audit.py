...
NEW_REV = '74d241161eadf2121128f6fd9101ead18e562765'
REDIS_REV = CLIENT_REV
REDIS_SOURCE = SOURCE
PINS = {
 'old': (OLD_REV, 'b33b5d302f901aac5cf6a95449b9bb5dd68473747e011220dbed7aed2e591d13'),
 'new': (NEW_REV, '3fc1c4c0c8f7b2c8ffead879b8228aef139aa2c443b647f38c7722a8e33668f0'),
...
ROLE_PATHS = {
 ...
 'new': ('/tmp/kv9-indexed-apply-receipts', '/tmp/kv9-indexed-receipt-release-first', 'kv9'),
...
SERVER_MANIFESTS = {
 ...
 'new': '406c397f56e8d7f177aa540dbddbdda21ba9d0d9f159b0cb83694acfc92275f6',
}
...
try:
    ...
    expected_argv=['/usr/bin/python3','/tmp/kv9-indexed-receipt-screen-preparation/matched-driver.py',
                   ...
                   '--new-server-source','/tmp/kv9-indexed-apply-receipts',
                   '--new-server-build','/tmp/kv9-indexed-receipt-release-first',
    ...
    require(invocation['argv']==expected_argv and invocation['wrapper_sha256']==
            ...
            invocation['driver_arguments_sha256']=='66e964b0e30ff48020ee7c2fadbbdf07873c0ef09ad1b80a022ec99945029a40',
    ...
    require(matrix['helper_hashes'][str(Path('/tmp/kv9-indexed-receipt-screen-preparation/matched-driver.py'))]==args.expected_driver_sha256,
