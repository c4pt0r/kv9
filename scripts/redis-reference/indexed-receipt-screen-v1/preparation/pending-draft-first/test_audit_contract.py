...
def matrix():
    ...
    return dict(version=2,protocol_id='kv9-indexed-receipt-write-screen-c1-c64-v1',concurrency_points=[1,64],
...
class AuditContract(unittest.TestCase):
    ...
    def test_exact_source_and_client_role_pins(self):
        ...
        self.assertEqual(audit['PINS']['new'],('74d241161eadf2121128f6fd9101ead18e562765',
            'PENDING_ORIGINAL_CANDIDATE_BINARY_SHA256'))
