...
def main():
    ...
    try:
        ...
        invocation = [sys.executable, str(args.driver)]
        save(args.output / 'invocation.json', dict(argv=invocation, driver_sha256=driver_sha256, wrapper_sha256=hashlib.sha256(Path(__file__).read_bytes()).hexdigest()))
        ...
        require(hashlib.sha256(args.driver.read_bytes()).hexdigest() == driver_sha256, 'recording driver changed during execution')
