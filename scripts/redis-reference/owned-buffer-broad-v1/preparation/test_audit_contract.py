...
def matrix():
    ...
    return dict(version=2,protocol_id='kv9-owned-batch-broad-workloads-c1-c64-v1',concurrency_points=[1,64],
...
class AuditContract(unittest.TestCase):
    ...
    def test_exact_source_and_client_role_pins(self):
        ...
        self.assertEqual(audit['PINS']['new'],('9be0c1963515ff974426faadef80482b847b13a5',
            '07c02871276f9c52cd19bd8213ab3288d6c51a1d7391370b5a6282f0018b03f7'))
