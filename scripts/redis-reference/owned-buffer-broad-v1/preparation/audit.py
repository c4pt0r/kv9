...
NEW_REV = '9be0c1963515ff974426faadef80482b847b13a5'
REDIS_REV = CLIENT_REV
REDIS_SOURCE = SOURCE
PINS = {
 'old': (OLD_REV, 'b33b5d302f901aac5cf6a95449b9bb5dd68473747e011220dbed7aed2e591d13'),
 'new': (NEW_REV, '07c02871276f9c52cd19bd8213ab3288d6c51a1d7391370b5a6282f0018b03f7'),
...
PROTOCOL_ID = 'kv9-owned-batch-broad-workloads-c1-c64-v1'
CONCURRENCIES = (1, 64)
...
ROLE_PATHS = {
 ...
 'new': ('/tmp/kv9-owned-apply-batch', '/tmp/kv9-owned-batch-release-first', 'kv9'),
...
SERVER_MANIFESTS = {
 ...
 'new': '5a2d5e031f0a24a0704dd3a2d4cf4f0fc95f868d694b54d94c3fc56fb1243a21',
}
...
try:
    ...
    expected_argv=['/usr/bin/python3','/tmp/kv9-owned-batch-broad-workloads-preparation/matched-driver.py',
                   ...
                   '--new-server-source','/tmp/kv9-owned-apply-batch',
                   '--new-server-build','/tmp/kv9-owned-batch-release-first',
    ...
    require(matrix['helper_hashes'][str(Path('/tmp/kv9-owned-batch-broad-workloads-preparation/matched-driver.py'))]==args.expected_driver_sha256,
