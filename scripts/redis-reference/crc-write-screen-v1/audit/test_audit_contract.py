...
class AuditContract(unittest.TestCase):
    ...
    def test_phase_api_labels_and_mixed_population(self):
        ...
        c=config(0,1,'point-r050','old');r=phase_report(c,True)
