#!/usr/bin/env python3
"""Check concrete graph insertion with rejecting controls."""
import hashlib
import json
import os
...
contract = json.loads((PROOFS / 'heap-insert-contract.json').read_text())
...
def check(modules, label):
    ...
    (work / 'Audit.lean').write_text('import HeapInsertResult\n' +
