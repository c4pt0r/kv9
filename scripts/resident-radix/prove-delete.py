#!/usr/bin/env python3
"""Check indexed edge and iterative deletion refinement with rejecting controls."""
import hashlib
import json
import os
...
contract = json.loads((PROOFS / 'delete-contract.json').read_text())
...
def check(modules, label):
    ...
    (work / 'Audit.lean').write_text('import DeleteWordLoop\n' +
