#!/usr/bin/env python3
"""Check concrete graph deletion with rejecting controls."""
import hashlib
import json
import os
...
contract = json.loads((PROOFS / 'heap-delete-contract.json').read_text())
