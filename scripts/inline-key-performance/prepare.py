...
Q=Path('/mnt/data/kv9-work/inline-key-qualification-20260916-v2')
...
assert plan['execution_base']=='940d13e9a74f00834cf223eb72288566f108f4ea'
...
'''
    ...
    manifest=(R/f'scripts/{origin}/Cargo.toml').read_text().replace('kv9-'+origin,'kv9-inline-key-'+profile)
