...
pub use grpc::{
    ...
    revoke_admission_blocking, AuthContext, AuthKind, Authenticator, Kv9Grpc, PublicApiBackend,
    RawClient, RawClientOutcome, RawScanPage, TokenAuthenticator, LEADER_HINT_KEY, NOT_LEADER_KEY,
};
