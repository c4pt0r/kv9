...
with six fresh drains. The [actual 21-window Chaos baseline](WRITE-PUBLISHED-DIRECTORY-CHAOS.md)
also passes, with 9,372 complete operations, four fresh drains and all 33
observed server lifetimes exited. Positive segment-rotation/crash coverage and
a matched throughput/latency comparison remain required. Keep CRC main selected.
