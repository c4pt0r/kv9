...
try:
 ...
 index=dict(version=1,source_revision=binding['source_revision'],scope='Portable exact original observer-byte readback; actual semantic acceptance and outcomes are separately retained.',
