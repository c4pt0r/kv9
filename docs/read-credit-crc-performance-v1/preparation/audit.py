...
NEW_REV = 'de37c71009e8199859b931e0037818f490e8d3f6'
REDIS_REV = CLIENT_REV
REDIS_SOURCE = SOURCE
PINS = {
 'old': (OLD_REV, 'b33b5d302f901aac5cf6a95449b9bb5dd68473747e011220dbed7aed2e591d13'),
 'new': (NEW_REV, '5464adee210f7cebbce7cd57d6e01bfe5a1ace42936edad24f57e63ff9cfbdd7'),
...
PROTOCOL_ID = 'kv9-read-credit-crc-broad-workloads-c1-c64-v1'
CONCURRENCIES = (1, 64)
...
ROLE_PATHS = {
 ...
 'new': ('/tmp/kv9-read-credit-crc', '/tmp/kv9-read-credit-crc-release-rebuilt-first', 'kv9'),
...
SERVER_MANIFESTS = {
 ...
 'new': '164b7999386b042ad2df814fea44fe93724ae15396e9f0cae0356a926fc3d1de',
}
...
try:
    ...
    expected_argv=['/usr/bin/python3','/tmp/kv9-read-credit-crc-performance-preparation/matched-driver.py',
                   ...
                   '--new-server-source','/tmp/kv9-read-credit-crc',
                   '--new-server-build','/tmp/kv9-read-credit-crc-release-rebuilt-first',
    ...
    require(invocation['argv']==expected_argv and invocation['wrapper_sha256']==
            ...
            invocation['driver_arguments_sha256']=='6f1497dadeba0726d1c54e78d9bb8a47cc5db1fe3f2855f0504e0ec91aa8511b',
    ...
    require(matrix['helper_hashes'][str(Path('/tmp/kv9-read-credit-crc-performance-preparation/matched-driver.py'))]==args.expected_driver_sha256,
