...
def matrix():
    ...
    return dict(version=2,protocol_id='kv9-read-credit-crc-broad-workloads-c1-c64-v1',concurrency_points=[1,64],
...
class AuditContract(unittest.TestCase):
    ...
    def test_exact_source_and_client_role_pins(self):
        ...
        self.assertEqual(audit['PINS']['new'],('de37c71009e8199859b931e0037818f490e8d3f6',
            '5464adee210f7cebbce7cd57d6e01bfe5a1ace42936edad24f57e63ff9cfbdd7'))
