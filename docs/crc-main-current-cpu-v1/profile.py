...
DRIVER=Path('/tmp/kv9-crc-main-current-profile-preparation-20260914-first/matched-driver.py')
DRIVER_SHA='7d2c9c55a6ee5e6c6c1181145f7b055937b37fbcc8007d8ff9c75b6b74840431'
SOURCE=Path('/tmp/kv9-point-write-measurement-v3')
SERVER_SOURCE=Path('/tmp/kv9-crc-main-bd42-baseline-20260914-first')
SERVER_BUILD=Path('/tmp/kv9-crc-main-integration-release-20260914-first')
...
def main():
    ...
    protocol=dict(version=1,protocol_id='kv9-crc-main-bd42-write-active-prefix-cpu-v1',background_container_isolation=False,instrumented=True,throughput_acceptance=False,server_revision=driver.OLD_REVISION,
