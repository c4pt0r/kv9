...
SOURCE = Path('/tmp/kv9-quorum-trace-slots')
OUT = Path('/tmp/kv9-quorum-trace-slots-source-first')
...
def main():
    ...
    prepared = json.loads(Path('/tmp/kv9-quorum-trace-slots-root-first/commands-source.json').read_text())
