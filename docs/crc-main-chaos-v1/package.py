...
PREP = Path('/tmp/kv9-crc-main-chaos-publication-preparation-20260914-first/selection-first')
OUT = Path('/tmp/kv9-crc-main-integration-evidence-worktree-20260914-first/docs/crc-main-chaos-v1')
G = 1024**3
...
assert __debug__
B = read('/tmp/kv9-crc-main-chaos-root-20260914-first/publication-bindings.json')
assert B['source_revision'] == 'bd42e60f84657e22e36e34924a5c80a08eac623a'
...
runtime = Path('/tmp/kv9-crc-main-chaos-root-20260914-first')
assert B['post_root'] == '/tmp/kv9-crc-main-chaos-root-20260914-first'
