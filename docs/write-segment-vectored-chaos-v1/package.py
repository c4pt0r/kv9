...
PREP = Path('/tmp/kv9-write-segment-vectored-chaos-publication-preparation-first/selection-first')
OUT = Path('/tmp/kv9-write-segment-vectored-chaos-publication-first/docs/write-segment-vectored-chaos-v1')
G = 1024**3
...
assert __debug__
B = read('/tmp/kv9-write-segment-vectored-chaos-root-first/publication-bindings.json')
assert B['source_revision'] == 'cfd9c927f8ecd33974100f696e6b08b227d25a41'
...
runtime = Path('/tmp/kv9-write-segment-vectored-chaos-root-first')
assert B['post_root'] == '/tmp/kv9-write-segment-vectored-chaos-root-first'
