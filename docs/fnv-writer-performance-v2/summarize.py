...
PREP=Path('/tmp/kv9-fnv-writer-performance-budget-v2-preparation-20260914-first')
...
def main():
 ...
 try:
  ...
  assert aud['protocol_id']==protocol['protocol_id']=='kv9-fnv-writer-write-ab-c1-c64-storage-v2'and aud['successful_arms']==aud['expected_successful_arms']==16 and len(aud['cases'])==16
  ...
  matrix=bound(RUN/'matrix.json');smoke=bound(Path('/tmp/kv9-fnv-writer-performance-budget-v2-smoke-20260914-first/matrix.json'))
