...
OUT=Path('/home/dongxu/kv9/docs/raft-frame-buffer-recovery-v1')
ROOTS={
 'release-root':Path('/tmp/kv9-write-raft-frame-buffer-release-root-first'),
 'release':Path('/tmp/kv9-write-raft-frame-buffer-release-first'),
 'preparation':Path('/tmp/kv9-write-raft-frame-buffer-recovery-preparation-first'),
 'process':Path('/tmp/kv9-write-raft-frame-buffer-process-first'),
 'audit':Path('/tmp/kv9-write-raft-frame-buffer-recovery-audit-first')}
...
assert release['revision']==audit['revision']=='01d128fd771dfbf0e6826ee5b6821411afac1fec'
