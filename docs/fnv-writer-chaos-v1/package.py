...
PREP = Path('/tmp/kv9-fnv-writer-chaos-publication-20260914-first/selection-first')
OUT = Path('/tmp/kv9-fnv-writer-chaos-publication-20260914-first/package-first')
G = 1024**3
...
assert B['source_revision'] == '12f44d35590ede5f89337fe731dd950162865154'
...
runtime = Path('/tmp/kv9-fnv-writer-chaos-root-20260914-first')
assert B['post_root'] == '/tmp/kv9-fnv-writer-chaos-root-20260914-first'
