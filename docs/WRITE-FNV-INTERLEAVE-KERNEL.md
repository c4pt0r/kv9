...
The [source-bound Lean gate](../proofs/lean/fnv-interleave/README.md) passes
...
The [benchmark and runner](../experiments/fnv-interleave/README.md) include the
...
[Original proof, tests, failed development attempts and all kernel rows](fnv-interleave-kernel-v1/README.md)
